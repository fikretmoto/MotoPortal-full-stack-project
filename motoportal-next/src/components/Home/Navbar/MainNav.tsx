...
const MainNav = () => {
  return (
    <>
      ...
      <div className="border-b border-white/10 bg-[#050505] px-4 py-3 sm:px-6 lg:hidden">
        <form
          role="search"
        ...
        >
          <input
            ...
            className="h-11 min-w-0 flex-1 bg-white px-4 text-sm text-neutral-900 outline-none placeholder:text-neutral-500"
          />
          <button
            type="button"
