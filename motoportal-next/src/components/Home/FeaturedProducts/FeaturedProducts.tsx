...
function FeaturedProductCard({
  ...
  return (
    <Link
      ...
      className="group rounded-3xl border border-line bg-card transition hover:border-fg-subtle"
    >
      <article className="flex h-full flex-col overflow-hidden rounded-3xl">
        ...
        <div className="flex flex-1 flex-col p-6">
          <div className="flex flex-wrap items-center gap-3">
            <span className="rounded-full bg-surface px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-fg-muted">
              {product.brand.name}
            </span>
...
export default async function FeaturedProducts() {
  ...
  return (
    <section
      id="yeni-modeller"
      className="border-b border-line bg-background-soft"
    >
